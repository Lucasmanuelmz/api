...
categoryRouter.post('/categories', passport.authenticate('jwt', 
  {session: false}), validationCategory, categoryController.createCategory);
categoryRouter.get('/categories/:slug', categoryController.getCategoryBySlug);
categoryRouter.put('/categories/:id', passport.authenticate('jwt', {session: false}), validationCategory,  categoryController.updateCategoryById);
